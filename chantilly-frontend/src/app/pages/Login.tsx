...
export default function Login() {
  ...
  const { login, isAdmin, loading } = useApp();
    ...
    <div className="min-h-screen bg-[#F5F5F5] flex items-center justify-center px-4 py-10" style={{ fontFamily: "Poppins" }}>
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        <div className="text-center mb-6">
          ...
          <h1 className="text-[#333]" style={{ fontWeight: 700, fontSize: 24 }}>Iniciar SesiÃ³n</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input type={showPw ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"
          ...
          <div className="text-right">
            <Link to="/recuperar" className="text-[#D32F2F] hover:underline" style={{ fontSize: 14 }}>Â¿Olvidaste tu contraseÃ±a?</Link>
          </div>
        ...
        <p className="text-center mt-6 text-gray-500" style={{ fontSize: 14 }}>
          Â¿No tienes cuenta? <Link to="/registro" className="text-[#D32F2F] hover:underline" style={{ fontWeight: 600 }}>RegÃ­strate aquÃ­</Link>
        </p>
